...
Upstream cause was EDH: the 08-23 and 08-27 runs both finished at 20:3x UTC — exactly `16:30 + 4h`, `wait_for_edh.sh`'s hard cap — so EDH never published and the gate proceeded with stale data as designed. 08-24 passed the gate immediately yet still had a stale price column, which points at a *partial* publish (report timestamp fresh, ENTSO-E day-ahead missing).
