...
- **Known weakness in production**: lower-side coverage ~0.85 over the full eval log (1728 realised hours through 2026-06-02) vs nominal 0.90 target. Same as ARF era (0.82); swap doesn't worsen. Day-to-day coverage is bimodal — trailing-14 mean 0.76, worst day 0.33 — mean masks the worst days. Tracked formally as **augur#19**; augur#12 freshness dependency **resolved 2026-06-09**, so calibration follow-up (EXP-015..017) is now unblocked.
