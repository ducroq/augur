...
| Path | What it is |
|------|-----------|
| `experiments/registry.jsonl` | Append-only experiment log (EXP-001..EXP-029, gaps at EXP-017/024/027 which were never run); schema in `experiments/README.md` |
